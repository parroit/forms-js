...
InputDateBinder.prototype.ui2Model = function() {
    ...
    var dtValue = new Date(this.elm[this.DOMProperty]);
    var oldDtValue = this.object[this.name];
    if (!oldDtValue || oldDtValue.getTime() !== dtValue.getTime()) {
        this.object[this.name] = dtValue;
    }
